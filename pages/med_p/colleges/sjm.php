...
<div class="panel panel-primary" id="sjm">
<div class="panel-heading">St. John Medical College, Banglore</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/med_p/stjohn_banglore.jpg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='cosjm'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="cocmcv.php?clg=<?php echo comment('St. John Medical College, Banglore');?> &str=<?php echo stream('St. John Medical College, Banglore');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='nsjm'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="ncmcv.php?clg=<?php echo news('St. John Medical College, Banglore');?> &str=<?php echo stream('St. John Medical College, Banglore');?>">
