...
<div class="panel panel-primary" id="imsbhu">
<div class="panel-heading">Institute Of Medical Science(IMS) BHU</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/med_g/ims_bhu.jpg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='coimsbhu'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coaiimsd.php?clg=<?php echo comment('Institute Of Medical Science(IMS) BHU');?> &str=<?php echo stream('Institute Of Medical Science(IMS) BHU');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='nimsbhu'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="naiimsd.php?clg=<?php echo news('Institute Of Medical Science(IMS) BHU');?> &str=<?php echo stream('Institute Of Medical Science(IMS) BHU');?>">
