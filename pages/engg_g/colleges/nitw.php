<div class="panel panel-primary" id="nitw">
<div class="panel-heading">National Institute Of Technology(NIT) Warangal</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/engg_g/nit_warangal.jpg" alt="Responsive image" class="img-responsive"/>
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='conitw'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coiiith.php?clg=<?php echo comment('National Institute Of Technology(NIT) Warangal');?> &str=<?php echo stream('National Institute Of Technology(NIT) Warangal');?>">
              <h4>Comment to ask or know about college <small>  @ feel free </small></h4>
               <div class="form-group" style="padding:14px;">
                <textarea class="form-control" placeholder="@ feel free" name="coiitw"></textarea>
              </div>
...
<div class="panel-heading">News<span class="pull-right"><?php $se='niitw'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="niiith.php?clg=<?php echo news('National Institute Of Technology(NIT) Warangal');?> &str=<?php echo stream('National Institute Of Technology(NIT) Warangal');?>">
