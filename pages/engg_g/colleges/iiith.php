<div class="panel panel-primary" id="iiith">
<div class="panel-heading">Indian Institute Of Information Technology(IIIT) Hyderabad</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/engg_g/iiit_hyderabad.jpg" alt="Responsive image" class="img-responsive"/>
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='coiiith'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coiiith.php?clg=<?php echo comment('Indian Institute Of Information Technology(IIIT) Hyderabad');?> &str=<?php echo stream('Indian Institute Of Information Technology(IIIT) Hyderabad');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='niiith'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="niiith.php?clg=<?php echo news('Indian Institute Of Information Technology(IIIT) Hyderabad');?> &str=<?php echo stream('Indian Institute Of Information Technology(IIIT) Hyderabad');?>">
