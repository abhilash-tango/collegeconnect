...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    <h6 class="media-heading"><b>'.$name.'  </b><small>'.$kclg.' [posted on '.$samay.']</font></small></h6>
...
?>
  ...
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coiiith.php?clg=<?php echo comment('Indian Institute of Technology(IIT) Kanpur');?> &str=<?php echo stream('Indian Institute of Technology(IIT) Kanpur');?>">
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    <h6 class="media-heading"><b>'.$name.'  </b><small>'.$kclg.' [posted on '.$samay.']</small></h6>
    '.$kcom.'<br/><small>'.$delink.'</small>
  </div>
</div>');
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="niiith.php?clg=<?php echo news('Indian Institute of Technology(IIT) Kanpur');?> &str=<?php echo stream('Indian Institute of Technology(IIT) Kanpur');?>">
