<div class="panel panel-primary" id="iitbhu">
<div class="panel-heading">Indian Institute of Technology(IIT) BHU ,VARANASI</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/engg_g/iit_bhu.jpg" alt="Responsive image" class="img-responsive"/>
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='coiitbhu'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coiiith.php?clg=<?php echo comment('Indian Institute of Technology(IIT) BHU ,VARANASI');?> &str=<?php echo stream('Indian Institute of Technology(IIT) BHU ,VARANASI');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='niitbhu'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
