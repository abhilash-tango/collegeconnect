...
<div class="panel panel-primary" id="thap">
<div class="panel-heading">Thapar Institute Of Engineering and Technology Patiala</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/engg_p/thapar_patiala.jpg" alt="Responsive image" class="img-responsive"/>
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='cothap'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
...
<div class="panel-heading">News<span class="pull-right"><?php $se='nthap'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
