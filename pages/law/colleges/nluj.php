<div class="panel panel-primary" id="nluj">
<div class="panel-heading">National Law University ,Jodhpur</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/law/nlu_jodhpur.jpg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='conluj'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="conalsar.php?clg=<?php echo comment('National Law University ,Jodhpur');?> &str=<?php echo stream('National Law University ,Jodhpur');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='nnluj'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="nnalsar.php?clg=<?php echo news('National Law University ,Jodhpur');?> &str=<?php echo stream('National Law University ,Jodhpur');?>">
