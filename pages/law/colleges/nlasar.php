<div class="panel panel-primary" id="nalsar">
<div class="panel-heading">Nalsar University of Law , Hyderabad</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/law/nalsar_hyderabad.jpg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='conalsar'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="conalsar.php?clg=<?php echo comment('Nalsar University of Law , Hyderabad');?> &str=<?php echo stream('Nalsar University of Law , Hyderabad');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='nnalsar'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="nnalsar.php?clg=<?php echo news('Nalsar University of Law , Hyderabad');?> &str=<?php echo stream('Nalsar University of Law , Hyderabad');?>">
