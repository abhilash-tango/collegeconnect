<div class="panel panel-primary" id="nujs">
<div class="panel-heading">West Bengal National University of Juridical Sciences(NUJS) ,Kolkata</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/law/nujs_calcutta.jpg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='conujs'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="conalsar.php?clg=<?php echo comment('West Bengal National University of Juridical Sciences(NUJS) ,Kolkata');?> &str=<?php echo stream('West Bengal National University of Juridical Sciences(NUJS) ,Kolkata');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='nnujs'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="nnalsar.php?clg=<?php echo news('West Bengal National University of Juridical Sciences(NUJS) ,Kolkata');?> &str=<?php echo stream('West Bengal National University of Juridical Sciences(NUJS) ,Kolkata');?>">
