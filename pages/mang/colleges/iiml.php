<div class="panel panel-primary" id="iiml">
<div class="panel-heading">Indian Institute Of Management(IIM) Lucknow</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/mang/iim_lucknow.jpeg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='coiiml'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coiima.php?clg=<?php echo comment('Indian Institute Of Management(IIM) Lucknow');?> &str=<?php echo stream('Indian Institute Of Management(IIM) Lucknow');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='niiml'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="niima.php?clg=<?php echo news('Indian Institute Of Management(IIM) Lucknow');?> &str=<?php echo stream('Indian Institute Of Management(IIM) Lucknow');?>">
