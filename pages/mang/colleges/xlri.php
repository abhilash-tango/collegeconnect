<div class="panel panel-primary" id="xlri">
<div class="panel-heading">Xavier Labour Relations Institute of Management(XLRI) Jamshedpur</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/mang/xlri_jamshedpur.jpg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='coxlri'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coiima.php?clg=<?php echo comment('Xavier Labour Relations Institute of Management(XLRI) Jamshedpur');?> &str=<?php echo stream('Xavier Labour Relations Institute of Management(XLRI) Jamshedpur');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='nxlri'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="niima.php?clg=<?php echo news('Management Development Institute(MDI) ,Gurgaon');?> &str=<?php echo stream('Management Development Institute(MDI) ,Gurgaon');?>">
