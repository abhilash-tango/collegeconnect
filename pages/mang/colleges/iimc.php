<div class="panel panel-primary" id="iimc">
<div class="panel-heading">Indian Institute Of Management(IIM) Calcutta</div>
  <div class="panel-body">
   <div class="panel panel-primary pull-left col-md-6">
  <div class="panel-body">
    <img src="../../assets/college/mang/iim_calcutta.jpg" alt="Responsive image" class="img-responsive" />
  </div>
...
$sqll="SELECT * FROM  comment ORDER BY uid DESC ";
  ...
  <div class="media-body">
    ...
    '.$kcom.'<br/><small>'.$delink.'</small>
		...
		}$se='coiimc'; echo('<a href=../reqc.php?ud='.$se.'><font color="#3B5998"><small>View all</small></font></a>');
		
?>
  </div>
  <div class="panel-footer">
       <form class="form-horizontal" role="form" method="post" action="coiima.php?clg=<?php echo comment('Indian Institute Of Management(IIM) Calcutta');?> &str=<?php echo stream('Indian Institute Of Management(IIM) Calcutta');?>">
...
<div class="panel-heading">News<span class="pull-right"><?php $se='niimc'; echo('<a href=../req.php?ud='.$se.'><font color="white" size="1px">View all</font></a>');?></span></div>
  <div class="panel-body">
    <?php
...
?>
  ...
  <div class="panel-footer">
    <form class="form-horizontal" role="form" method="post" action="niima.php?clg=<?php echo news('Indian Institute Of Management(IIM) Calcutta');?> &str=<?php echo stream('Indian Institute Of Management(IIM) Calcutta');?>">
